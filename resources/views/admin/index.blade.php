                                    ...
                                    <table class="table table-hover">
                                        ...
                                        <tr>
                                            ...
                                            <td class="project-people">
                                                <a href="projects.html"><img alt="image" class="img-circle" src="{{ asset('vendor/hAdmin/img/a3.jpg') }}"></a>
                                                <a href="projects.html"><img alt="image" class="img-circle" src="{{ asset('vendor/hAdmin/img/a1.jpg') }}"></a>
                                                <a href="projects.html"><img alt="image" class="img-circle" src="{{ asset('vendor/hAdmin/img/a2.jpg') }}"></a>
                                                <a href="projects.html"><img alt="image" class="img-circle" src="{{ asset('vendor/hAdmin/img/a4.jpg') }}"></a>
                                                <a href="projects.html"><img alt="image" class="img-circle" src="{{ asset('vendor/hAdmin/img/a5.jpg') }}"></a>
                                            </td>
                                        ...
                                        <tr>
                                            ...
                                            <td class="project-people">
                                                <a href="projects.html"><img alt="image" class="img-circle" src="{{ asset('vendor/hAdmin/img/a7.jpg') }}"></a>
                                                <a href="projects.html"><img alt="image" class="img-circle" src="{{ asset('vendor/hAdmin/img/a6.jpg') }}"></a>
                                                <a href="projects.html"><img alt="image" class="img-circle" src="{{ asset('vendor/hAdmin/img/a3.jpg') }}"></a>
                                            </td>
                                            <td class="project-actions">
                                                <a href="projects.html#" class="btn btn-white btn-sm"><i class="fa fa-folder"></i> 查看 </a>
...
@section('scripts')
    <!-- Flot -->
    <script type="text/javascript" src="{{ asset('vendor/hAdmin/js/demo/flot-demo.js') }}"></script>

    <script type="text/javascript" src="{{ asset('vendor/hAdmin/js/plugins/flot/jquery.flot.js') }}"></script>
    <script type="text/javascript" src="{{ asset('vendor/hAdmin/js/plugins/flot/jquery.flot.tooltip.min.js') }}"></script>
    <script type="text/javascript" src="{{ asset('vendor/hAdmin/js/plugins/flot/jquery.flot.resize.js') }}"></script>
    <script type="text/javascript" src="{{ asset('vendor/hAdmin/js/plugins/flot/jquery.flot.pie.js') }}"></script>

    <!-- 自定义js -->
    <script src="{{ asset('vendor/hAdmin/js/content.js') }}"></script>
    <!--flotdemo-->
