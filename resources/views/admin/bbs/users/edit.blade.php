        ...
        <div class="col-sm-12">
            <div class="ibox float-e-margins">
                ...
                <div class="ibox-content">
                    <form class="form-horizontal m-t formAjax" id="commentForm" method="post" action="{{ route('admin.bbs.users.update', [$user->id]) }}">
                        {{ csrf_field() }}
                        {{ method_field('PUT') }}
                        ...
                        <div class="form-group">
                            ...
                            <div class="col-sm-8">
                                ...
                                <input type="hidden" class="form-control" name="avatar" value="{{ $user->avatar or '' }}">
                            </div>
                        </div>
                        <div class="form-group">
