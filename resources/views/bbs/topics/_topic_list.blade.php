        ...
        @foreach ($topics as $topic)
            <li class="media">
                <div class="media-left">
                    <a href="{{ route('bbs.users.show', [$topic->user_id]) }}">
                ...
                <div class="media-body">
                    ...
                    <div class="media-body meta">
                        ...
                        <a href="{{ route('bbs.categories.show', $topic->category->id) }}" title="{{ $topic->category->name }}">
                            <span class="glyphicon glyphicon-folder-open" aria-hidden="true"></span>
                            {{ $topic->category->name }}
                        </a>

                        <span> • </span>
                        <a href="{{ route('bbs.users.show', [$topic->user_id]) }}" title="{{ $topic->user->name }}">
